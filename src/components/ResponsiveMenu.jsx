...
const ResponsiveMenu = ({showMenu,setShowMenu}) => {
  return (
    ...
    justify-between bg-gray-950 px-8 pb-6 pt-16 text-black md:hidden rounded-r-xl shadow-md transition-all`}>
        ...
        <div>
            ...
            <nav className='mt-12'>
                <ul className='flex flex-col gap-7 text-lg font-semibold text-white'>
                    ...
                    <a href='#education'><li className='cursor-pointer'onClick={()=> setShowMenu(false)}>Education & Exprerience</li></a>

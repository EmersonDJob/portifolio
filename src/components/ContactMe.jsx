...
const ContactMe = () => {
  return (
    <section id='contactMe' className='bg-gray-950 py-16 px-6'>
      <div className='max-w-7xl mx-auto'>
        <h2 className='text-5xl font-bold text-center text-gray-300 mb-12'>Contate me</h2>
        <div className='grid lg:grid-cols-2 gap-10'>
            {/* contact info */}
            <div className='flex flex-col justify-center space-y-8'>
                <div>
                    <h1 className='text-4xl lg:text-6xl font-bold text-gray-300'>Fale comigo</h1>
                ...
                <div>
                    <h3 className='text-2xl font-semibold text-gray-300'>Siga me</h3>
